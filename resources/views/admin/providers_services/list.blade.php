							...
							<div>
								...
								<div class="n-chk">
									<label class="new-control new-radio new-radio-text radio-primary">
										<input type="radio" onchange="selectCharType(this)" class="new-control-input" name="type" value="self_checkbox">
										<span class="new-control-indicator"></span><span class="new-radio-content">
											Самодобавляемый (Поставщик сам может добавить нужные ему значения)
										</span>
									</label>
								</div>
